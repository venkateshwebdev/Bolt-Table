...
export const SparklesIcon: React.FC<IconProps> = ({ style, className }) => (
  <svg {...svgBase} style={style} className={className}>
...
export const SendIcon: React.FC<IconProps> = ({ style, className }) => (
  <svg {...svgBase} style={style} className={className}>
...
export const LoaderIcon: React.FC<IconProps> = ({ style, className }) => (
  <svg {...svgBase} style={style} className={className}>
    <path d="M21 12a9 9 0 1 1-6.219-8.56" />
  </svg>
);

export const MaximizeIcon: React.FC<IconProps> = ({ style, className }) => (
  <svg {...svgBase} style={style} className={className}>
...
export const MinimizeIcon: React.FC<IconProps> = ({ style, className }) => (
  <svg {...svgBase} style={style} className={className}>
